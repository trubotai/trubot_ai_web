...
const vpTechnologyPageData: CareerPageDataType = {
  id: "vp-technology",
  title: "Vice President of Technology",
  location: "Remote (Global)",
  type: "Full-Time",
  shortDescription:
    "Shape the future of AI at TruBot AI. Drive innovation, lead engineering teams, and own the tech strategy as VP of Technology.",
  about:
  ...
  responsibilities: [
    ...
    "Establish engineering best practices, coding standards, and DevOps strategies.",
    "Collaborate cross-functionally with product, sales, and executive teams to align business and technology goals.",
    "Ensure data security, compliance, and risk management across the tech stack.",
    "Build and scale MLOps infrastructure and support the lifecycle of AI/ML models in production.",
    "Represent technology to investors, partners, and clients as needed.",
  ],
  qualifications: [
    "10+ years in software engineering with 5+ years in senior technical leadership roles.",
    "Proven experience leading cross-functional engineering teams in fast-paced environments.",
    "Deep understanding of cloud architecture (AWS, GCP, or Azure) and scalable system design.",
    "Strong grasp of AI/ML ecosystems and familiarity with modern frameworks (TensorFlow, PyTorch, etc.).",
    "Hands-on experience in DevOps, CI/CD, data pipelines, and security best practices.",
    ...
    "Passion for technology, innovation, and building impactful products.",
  ],
  benefits: [
