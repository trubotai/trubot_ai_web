...
const legalAdvisorPageData: CareerPageDataType = {
  id: "board-advisor-legal",
  title: "Board Advisor – Legal & Compliance",
  ...
  responsibilities: [
    ...
    "Support funding rounds with legal strategy.",
    "Guide employment, partnership, and governance policies.",
    "Help prepare for international expansion and legal scalability.",
  ],
  qualifications: [
    "10–25+ years in legal leadership (General Counsel, Tech Law Partner).",
    "Experience with SaaS, IP law, and startup structuring.",
    "Knowledge of GDPR, data privacy, and cybersecurity.",
    "Pragmatic legal thinker with strategic depth.",
  ],
  benefits: [
