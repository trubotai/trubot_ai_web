...
const cfoPageData: CareerPageDataType = {
  ...
  responsibilities: [
    ...
    "Create and manage forecasting models, budgets, and financial KPIs tailored to an AI/SaaS startup.",
    "Monitor burn rate, runway, and cash flow with agility and transparency.",
    "Set up scalable accounting systems and financial reporting processes.",
    "Ensure regulatory and tax compliance across global jurisdictions.",
    "Advise the executive team on financial implications of business decisions and market opportunities.",
    "Support due diligence processes and strategic planning for potential partnerships or acquisitions.",
  ],
  qualifications: [
    "7–15+ years of experience in finance, preferably in early-stage startups or high-tech/AI companies.",
    "Demonstrated success in fundraising and financial leadership in fast-paced environments.",
    "Strong grasp of SaaS metrics, startup finance, and early-stage equity structures (SAFE, equity pools, etc.).",
  ...
  benefits: [
    ...
    "🚀 Remote & Flexible – Work globally on your schedule.",
    "💰 Performance-Based Compensation – Earn equity with the potential for a high-impact financial role.",
