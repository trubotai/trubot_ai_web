...
const uiuxDesignerPageData: CareerPageDataType = {
  id: "designer-uiux",
  ...
  responsibilities: [
    "Design intuitive, responsive user interfaces for web and mobile platforms tailored to AI tools.",
    "Create wireframes, user flows, mockups, and interactive prototypes using tools like Figma or Adobe XD.",
    "Collaborate with product managers, developers, and AI engineers to refine user experience.",
    "Conduct user research, usability testing, and gather feedback to iterate on designs.",
    "Develop and maintain a consistent design system and UI standards.",
    "Stay current with design trends, user behavior, and AI-related UI/UX practices.",
    "Ensure accessibility and usability across devices and user demographics.",
  ],
  qualifications: [
    "3 to 8+ years of experience in UI/UX design for AI, SaaS, or tech-driven platforms.",
    "Strong portfolio demonstrating design thinking, attention to detail, and user-centric solutions.",
    "Proficiency in tools like Figma, Adobe XD, Sketch, or similar.",
    "Understanding of designing for conversational UI (chatbots, voicebots) is a strong plus.",
    "Basic knowledge of HTML/CSS is a bonus.",
    "Excellent communication and collaboration skills.",
    "Self-driven, organized, and passionate about creating delightful user experiences.",
  ],
  benefits: [
