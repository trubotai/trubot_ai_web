...
const fundraisingManagerPageData: CareerPageDataType = {
  ...
  responsibilities: [
    ...
    "Pitch Decks & Proposals – Create compelling investor presentations, proposals, and financial models.",
    "Partnership Development – Build strategic partnerships and strengthen investor networks.",
    "Financial Planning – Align capital-raising efforts with long-term business goals and expansion strategy.",
  ],
  qualifications: [
    "3+ years of experience in fundraising, investor relations, or business development.",
    "Proven track record of raising capital for startups or technology-driven ventures.",
    "Excellent communication, negotiation, and presentation skills.",
    "Strong understanding of AI and emerging tech landscapes, trends, and investor expectations.",
  ],
  benefits: [
  ...
  applyInstructions:
    "To apply, please email your resume to careers@trubotai.com with the subject line: 'Application for Fundraising Manager'.",
