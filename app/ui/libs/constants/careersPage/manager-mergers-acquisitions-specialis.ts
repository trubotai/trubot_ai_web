...
const MASpecialistManagerPageData: CareerPageDataType = {
  ...
  responsibilities: [
    ...
    "Oversee smooth integration of acquired companies and drive synergy realization.",
    "Support acquisition-related fundraising and investment activities.",
    "Build relationships with investors, advisors, and industry stakeholders to strengthen market positioning.",
  ],
  qualifications: [
    "Experience in M&A, corporate finance, investment banking, or strategic partnerships is preferred.",
    "Candidates with transferable experience in negotiation, financial modeling, and strategic thinking are encouraged to apply.",
    "Strong collaboration and communication skills across departments and external stakeholders.",
    "Excellent financial analysis and leadership abilities to manage complex deal processes.",
    "Proactive, self-starter with the ability to drive projects independently in a dynamic environment.",
    "Comfortable working in fast-paced, growth-stage startup environments.",
  ],
  benefits: [
  ...
  applyInstructions:
    "To apply, please email your resume to careers@trubotai.com with the subject line: 'Application for M&A Specialist Manager'.",
