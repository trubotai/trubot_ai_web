...
const productManagerPageData: CareerPageDataType = {
  id: "manager-product",
  ...
  responsibilities: [
    ...
    "Conduct market and customer research to uncover needs and trends.",
    "Use data-driven insights to optimize and refine product offerings.",
    "Collaborate cross-functionally to ensure seamless product delivery.",
  ],
  qualifications: [
    "4+ years of experience in product management, preferably in AI, SaaS, or automation sectors.",
    "Strong technical understanding of AI technologies like NLP and machine learning.",
    "Proficiency with Agile methodologies, sprint planning, and roadmap execution.",
    "Excellent communication and stakeholder management skills.",
    "Strategic mindset with hands-on ability to manage end-to-end product lifecycles.",
  ],
  benefits: [
