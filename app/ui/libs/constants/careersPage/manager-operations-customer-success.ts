...
export const customerSuccessManagerPageData: CareerPageData = {
  ...
  responsibilities: [
    ...
    "Provide technical assistance and support to resolve customer queries efficiently.",
    "Analyze usage data to identify optimization opportunities and improve product adoption.",
    "Collaborate with sales and product teams to enhance the overall customer experience.",
  ],
  qualifications: [
    "3+ years of experience in customer success, client onboarding, or account management, preferably in AI, SaaS, or B2B technology companies.",
    "Proven ability to manage customer relationships and increase retention rates.",
    "Excellent communication and troubleshooting skills with a customer-first mindset.",
    "Strong analytical skills to monitor customer health metrics and propose improvements.",
    "Passion for technology, AI innovation, and delivering outstanding customer experiences.",
  ],
  benefits: [
    "🌍 Equity Ownership – Play a key role in shaping the future of TruBot AI.",
    "🚀 Remote & Flexible – Work globally, collaborate remotely, and manage your schedule.",
