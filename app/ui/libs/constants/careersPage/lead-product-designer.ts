...
const leadProductDesignerPageData: CareerPageDataType = {
  ...
  benefits: [
    "🌍 Equity Ownership – Be a key stakeholder in building our design culture and brand identity.",
    "🚀 Remote & Flexible – Work from anywhere while making a real impact.",
    "💰 Performance-Based Compensation – Transitioning to competitive salary as we grow.",
