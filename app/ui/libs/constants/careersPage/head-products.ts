...
const headProductsPageData: CareerPageDataType = {
  ...
  responsibilities: [
    "Product Strategy & Vision – Define and align the product roadmap with overall business objectives.",
    "Feature Development – Oversee the end-to-end execution of product features from ideation to release.",
    "Market Research – Conduct research and gather insights to uncover customer pain points and market opportunities.",
    "Data-Driven Decision Making – Leverage product metrics and feedback to continuously improve offerings.",
    "Stakeholder Collaboration – Work cross-functionally to ensure smooth product launches and ongoing alignment.",
  ],
  qualifications: [
    "5+ years of experience in product management, preferably in AI, SaaS, or tech startups.",
    "Strong technical understanding of AI, NLP, automation, and emerging technologies.",
    "Hands-on experience with Agile methodologies and iterative product development.",
    "Ability to drive both high-level product vision and detailed execution.",
  ],
  benefits: [
